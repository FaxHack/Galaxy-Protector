...
public static class LocalField
{
    ...
    public static void Process(ModuleDef module, MethodDef method)
    {
        ...
        foreach (var t in instructions)
        {
            ...
            {
                def = new FieldDefUser(Undetected.RandomStringStrong(39), new FieldSig(local.Type), FieldAttributes.Public | FieldAttributes.Static);
